...
>(({ className, variant = 'outline', size = 'icon', ...props }, ref) => {
  ...
  return (
    <Button
      ...
      size={size}
      className={cn(
        'absolute size-9 border border-dark-brown rounded-full',
        orientation === 'horizontal'
...
>(({ className, variant = 'outline', size = 'icon', ...props }, ref) => {
  ...
  return (
    <Button
      ...
      {...props}
    >
      <Image src={Next} width={10} height={10} alt='Next' className='w-5' />
        ...
        {Array.from({ length: numberOfSlides }, (_, i) => (
          <Button
            ...
            className={`mx-1 h-1.5 w-1.5 rounded-full p-0 ${
              i === currentSlide
                ? 'scale-105 transform bg-light-brown hover:bg-gray-500'
